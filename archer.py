...
SMART_FALLBACKS = {
    ...
    'trans':       lambda: f'Trans temp is {truck_state["trans_temp"]}F. {"Running hot." if truck_state["trans_temp"] > 200 else "Nominal."}',
    'transmission':lambda: f'Trans temp is {truck_state["trans_temp"]}F. {"Running hot." if truck_state["trans_temp"] > 200 else "Nominal."}',
